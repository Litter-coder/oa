...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public List<GrantedAuthority> getAuthorities(Long userId) {
		...
		List<SysUserRole> sysUserRoles = sysUserService.getSysUserRolesByUserId(userId);

		if (sysUserRoles != null) {
			for (SysUserRole sysUserRole : sysUserRoles) {
				GrantedAuthority authority = new GrantedAuthorityImpl(sysUserRole.getRoleId().toString());
